...
rectMode(CORNER);
  ...
  case 0:
    ...
    out.playNote( 1.f, 4.4f, new WaveShaperInstrument( Frequency.ofPitch("C2").asHz(), 0.1, out ) );
    out.playNote( 1.2f, 1.2f, new WaveShaperInstrument( Frequency.ofPitch("E2").asHz(), 0.1, out ) );
    out.playNote( 1.2f, 1.2f, new WaveShaperInstrument( Frequency.ofPitch("G2").asHz(), 0.1, out ) );
    break;

  case 1:

    out.playNote( 1.f, 4.4f, new WaveShaperInstrument( Frequency.ofPitch("G2").asHz(), 0.1, out ) );
    out.playNote( 1.2f, 1.2f, new WaveShaperInstrument( Frequency.ofPitch("B2").asHz(), 0.1, out ) );
    out.playNote( 1.2f, 1.2f, new WaveShaperInstrument( Frequency.ofPitch("D3").asHz(), 0.1, out ) );
    break;

  case 2:

    out.playNote( 1.f, 4.4f, new WaveShaperInstrument( Frequency.ofPitch("B3").asHz(), 0.1, out ) );
    out.playNote( 1.2f, 1.2f, new WaveShaperInstrument( Frequency.ofPitch("D#3").asHz(), 0.1, out ) );
    out.playNote( 1.2f, 1.2f, new WaveShaperInstrument( Frequency.ofPitch("F#3").asHz(), 0.1, out ) );
    break;

  case 3:

    out.playNote( 1.f, 4.4f, new WaveShaperInstrument( Frequency.ofPitch("F3").asHz(), 0.1, out ) );
    out.playNote( 1.2f, 1.2f, new WaveShaperInstrument( Frequency.ofPitch("G#3").asHz(), 0.1, out ) );
    out.playNote( 1.2f, 1.2f, new WaveShaperInstrument( Frequency.ofPitch("C4").asHz(), 0.1, out ) );
    break;
  }
