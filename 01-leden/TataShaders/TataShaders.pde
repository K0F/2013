...
void INIT_SHADER() {
   ...
   mat.set("NR_Ammount", 0.001);
 
  mat.set("AmbientColour", 0.01, 0.01, 0.01);
  mat.set("DiffuseColour", 1.0, 1.0, 1.0);
  mat.set("SpecularColour", 0.2, 0.2, 0.2);
  mat.set("AmbientIntensity", 0.0);
  mat.set("DiffuseIntensity", 1.0);
  mat.set("SpecularIntensity", 0.02);
  mat.set("Roughness", 0.6);
...
//pointLight(250, 250, 250, 1000,1000,1000);
