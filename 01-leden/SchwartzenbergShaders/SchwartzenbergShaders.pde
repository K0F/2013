...
void setup() {
  ...
  diff = loadImage("F.png");
  norm = loadImage("normalF.png");
  //diff = loadImage("checker.png");


  character = loadShape("schwarzenberg.obj");
...
void draw() {
 ...
 // lights();
  ...
  pointLight(250, 250, 250, (cos(frameCount/60.0))*200, (cos(frameCount/60.0))* -200, 200);

  //rotateY(frameCount/320.0);
